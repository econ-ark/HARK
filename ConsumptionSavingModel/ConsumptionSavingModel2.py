...
class consumptionSavingSolverKinkedClass(object):
    
    def defineUtilityAndValueFunctions(self,rho):
    ...
    def defineBorrowingConstraint(self,solution_tp1,R_borrow,Gamma,constraint):
        
        # Calculate the minimum allowable value of money resources in this period
        self.m_underbar_t = max((solution_tp1.m_underbar - self.xi_underbar_tp1)*
                                (Gamma*self.psi_underbar_tp1)/R_borrow, constraint)
    ...
    def __init__(self,solution_tp1,income_distrib,p_zero_income,survival_prob,beta,rho,
        ...
        self.defineUtilityAndValueFunctions(rho)

        self.setAndUpdateValues(solution_tp1,income_distrib,survival_prob,beta)

        self.defineBorrowingConstraint(solution_tp1,R_borrow,Gamma,constraint)
...
def consumptionSavingSolverKinkedR2(solution_tp1,income_distrib,p_zero_income,survival_prob,beta,rho,
    ...
    solver = consumptionSavingSolverKinkedClass(solution_tp1,income_distrib,p_zero_income,survival_prob,beta,rho,
                                   R_save,R_borrow,Gamma,constraint,a_grid,calc_vFunc,cubic_splines)
...
class consumptionSavingSolverClassEndg(consumptionSavingSolverClass):

    def defineUtilityAndValueFunctionsNew(self,rho):
        self.defineUtilityAndValueFunctions(rho)
    ...
    def __init__(self,rho):        
        ...
        self.defineUtilityAndValueFunctionsNew(rho)    
