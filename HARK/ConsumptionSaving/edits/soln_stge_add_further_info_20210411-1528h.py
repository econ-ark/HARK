def dummy
    ...
    """
        ...
        soln_stge.Rfree = Rfree = self.stge_futr.Rfree
        DiscFacNxt = DiscFac_0_ = self.stge_futr.DiscFac
        PermGroFacNxt = PermGroFac_0_ = self.stge_futr.PermGroFac
        LivPrbNxt = LivPrb_0_ = self.stge_futr.LivPrb
        DiscFacNxtEff = DiscFac_0_Eff = DiscFac_0_ * LivPrb_0_
        CRRANxt = CRRA = self.stge_futr.CRRA
        UnempPrbNxt = UnempPrb = \
            self.stge_futr.IncShkDstn.parameters['UnempPrb']
        UnempPrbRetNxt = UnempPrbRet = \
            self.stge_futr.IncShkDstn.parameters['UnempPrbRet']
