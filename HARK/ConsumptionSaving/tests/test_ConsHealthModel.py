...
class testBasicHealthConsumerType(unittest.TestCase):
    ...
    def test_solution(self):
        ...
        self.assertAlmostEqual(vNvrs, 179.1844, places=HARK_PRECISION)
        self.assertAlmostEqual(cLvl, 3.6561, places=HARK_PRECISION)
        self.assertAlmostEqual(nLvl, 0.6016, places=HARK_PRECISION)
