...
def solveConsPortfolio(
    ...
    if IndepDstnBool:  # If the distributions ARE independent...
        ...
        bNrm_tiled = np.tile(np.reshape(bNrmGrid, (bNrm_N, 1)), (1, Share_N))
        ...
        dvds_intermed = (
            PermGroFac ** (-CRRA)
            * calc_expectation(IncShkDstn, dvds_dist, bNrm_tiled, Share_tiled)[:, :, 0]
        )
