...
class Bounds(SimpleNamespace):
    """
    Objects that define boundaries.  For example, minima or maxima,
    domains, ranges
    """
    pass
...
class Facts(SimpleNamespace):
    """
    Facts and results calculated about the problem
    """
    pass


class Shocks(SimpleNamespace):
    """
    Facts and results calculated about the problem
    """
    pass
