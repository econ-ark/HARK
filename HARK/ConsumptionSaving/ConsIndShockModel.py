...
class PerfForesightConsumerType(AgentType):
    ...
    def check_restrictions(self):  # url/#check-restrictions
        ...
        # if np.min(self.PermGroFac) < 0:
        #     raise Exception("min[PermGroFac] is negative with value: " + str(np.min(self.PermGroFac))
