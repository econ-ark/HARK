...
def setup_latex_env_notebook(pf, latexExists):
    ...
    if latexExists:
        latex_preamble = (
            ...
            r"\providecommand{\HLvl}{{\mathbf{H}}}"
            r"\providecommand{\hLvl}{{\mathbf{h}}}"
            r"\providecommand{\HNrm}{H}"
            r"\providecommand{\hNrm}{h}"
            r"\providecommand{\KLvl}{{\mathbf{K}}}"
            r"\providecommand{\kLvl}{{\mathbf{k}}}"
            r"\providecommand{\KNrm}{K}"
            r"\providecommand{\kNrm}{k}"
            r"\providecommand{\MLvl}{{\mathbf{M}}}"
            r"\providecommand{\mLvl}{{\mathbf{m}}}"
            ...
            r"\providecommand{\VLvl}{{\mathbf{V}}}"
            r"\providecommand{\vLvl}{{\mathbf{v}}}"
            r"\providecommand{\VNrm}{V}"
            r"\providecommand{\vNrm}{v}"
            r"\providecommand{\YLvl}{{\mathbf{Y}}}"
            r"\providecommand{\yLvl}{{\mathbf{y}}}"
...
def make_figs(figure_name, saveFigs, drawFigs, target_dir="Figures"):
    ...
    if saveFigs:
        ...
        plt.savefig(os.path.join(target_dir, "{}.svg".format(figure_name)),metadata={'CreationDate': None})  # For html5
