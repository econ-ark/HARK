...
pref_shock_mag = (
    0.5  # Scaling factor for the magnitude of transitory style preference shocks
)
pNextIntercept = (
    0.1  # Intercept of linear function of beliefs over next period's punk proportion
)
pNextSlope = (
    0.8  # Slope of linear function of beliefs over next period's punk proportion
)
pNextWidth = 0.1  # Width of uniform distribution of next period's punk proportion (around linear function)
pNextCount = (
    10  # Number of points in discrete approximation to distribution of next period's p
)
