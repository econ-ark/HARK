...
aXtraNestFac = (
    3  # Exponential nesting factor when constructing "assets above minimum" grid
)
...
PermShkAggCount = (
    1  # Number of points in discrete approximation to aggregate permanent shock dist
)
TranShkAggCount = (
    1  # Number of points in discrete approximation to aggregate transitory shock dist
)
