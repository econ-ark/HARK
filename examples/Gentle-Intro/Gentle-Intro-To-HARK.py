...
# %%
mPlotTop = 10
plotFuncs(PFexample.solution[0].cFunc, 0.0, mPlotTop)
...
# %%
plotFuncs(PFexample.solution[0].cFunc, mMinimum, mPlotTop)
...
plotFuncs([PFexample.solution[0].cFunc, NewExample.solution[0].cFunc], 0.0, 10.0)
...
plotFuncs(IndShockExample.solution[0].cFunc, 0.0, 10.0)
