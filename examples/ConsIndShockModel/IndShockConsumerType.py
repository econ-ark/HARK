...
#
# \begin{eqnarray*}
#    v_{t,0}(m_{t,0}) &=& \max_{c_{t,0}} {~} u(c_{t,0}) + \DiscFac v_{t,1}(m_{t,1})
# \\ v_{t,1}(m_{t,1}) &=& \max_{c_{t,1}} {~} u(c_{t,1}) + \DiscFac v_{t,2}(m_{t,2})
# \\ v_{t,2}(m_{t,2}) &=& \max_{c_{t,2}} {~} u(c_{t,2}) + \DiscFac v_{t,3}(m_{t,3})
# \\ v_{t,3}(m_{t,3}) &=& \max_{c_{t,3}} {~} u(c_{t,3}) + \DiscFac v_{t+1,0}(m_{t+1,0})
# \end{eqnarray*}
#
