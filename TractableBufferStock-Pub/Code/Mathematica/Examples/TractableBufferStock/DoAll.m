...
\[ScriptC]GroMax=Log[\[ScriptCapitalC]tp1O\[ScriptCapitalC]t[0.5` \[ScriptM]E]];
...
,PlotRange->{{0,2.5` \[ScriptM]E},{HorizAxis,\[ScriptC]GroMax}}
]
(*,Graphics[{Dashing[{0.005`,0.025`}],Thickness[Medium],Black,Line[{{\[ScriptM]E,HorizAxis},{\[ScriptM]E,\[ScriptC]GroMax}}]}]*)
,Graphics[{Dashing[{}],Thickness[Small],Black,Line[{{\[ScriptM]E,HorizAxis},{\[ScriptM]E,\[ScriptC]GroMax}}]}]
...
,AxesOrigin->{((r)-\[CurlyTheta])/\[Rho]-0.1,HorizAxis}
,PlotRange->{{((r)-\[CurlyTheta])/\[Rho]-0.1,2.5` \[ScriptM]E},{HorizAxis,\[ScriptC]GroMax}}];
...
FindStableArm;
cFuncPlotNew=Plot[cE[\[ScriptM]],{\[ScriptM],0,\[ScriptM]MaxMax},PlotStyle->{Black,Thickness[Medium]}];
cFuncPlotNewPoints=Map[{{#,\[ScriptC][#]}}&,Table[\[ScriptM],{\[ScriptM],0,\[ScriptM]MaxMax,0.01}]];
Stable\[ScriptM]LocusPlot=Plot[{\[ScriptM]EDelEqZero[\[ScriptM]]},{\[ScriptM],0,\[ScriptM]MaxMax},PlotStyle->{Dashing[{.01}],Thickness[Medium],Black}];
...
{\[ScriptC]MinNew,\[ScriptC]MaxNew}={0,1.5 \[ScriptC]EBase};
...
,Graphics[Text["Orig Target \[LowerRightArrow]",{\[ScriptM]EBase,1.02\[ScriptC]EBase},{1,0}]]
,Graphics[Text["New Target\[LowerRightArrow] ",{\[ScriptM]E,1.03\[ScriptC]E},{1,0}]]
,Graphics[Text["Orig c(\[ScriptM]) \[LongRightArrow]",{0.45\[ScriptM]EBase,0.67\[ScriptC]EBase},{1,0}]]
,Graphics[Text[" \[LongLeftArrow] New c(\[ScriptM])",{0.9\[ScriptM]EBase,cE[0.9\[ScriptM]EBase]},{-1,0}]]
,Ticks->None
,AxesLabel->{"\[ScriptM]","\[ScriptC]"}
...
,Ticks->{{{\[ScriptM]E,"\!\(\*SuperscriptBox[OverscriptBox[\(\[ScriptM]\), \(\[Hacek]\)], \(e\)]\)"}},{{\[GothicG]+\[Mho],"\[Gamma]"},{((r)-\[CurlyTheta])/\[Rho],Style["\!\(\*SuperscriptBox[\(\[Rho]\), \(-1\)]\)(r-\[CurlyTheta])\[TildeTilde]\[Thorn]",CharacterEncoding->"WindowsANSI"]}}}
,PlotRange->{{0,2.1` \[ScriptM]E},{HorizAxis,\[ScriptC]GroMax}}
]
(*,Graphics[{Dashing[{0.005`,0.025`}],Thickness[Medium],Black,Line[{{\[ScriptM]E,HorizAxis},{\[ScriptM]E,\[ScriptC]GroMax}}]}]*)
,Graphics[{Dashing[{}],Thickness[Small],Black,Line[{{\[ScriptM]E,HorizAxis},{\[ScriptM]E,\[ScriptC]GroMax}}]}]
...
Stable\[ScriptM]LocusOrigPlot=Plot[{\[ScriptM]EDelEqZero[\[ScriptM]]},{\[ScriptM],0,\[ScriptM]MaxMax},PlotStyle->{Black,Dashing[{.01}],Thickness[Medium]}];

\[Mho]=3 \[Mho]Base;
FindStableArm;
cFuncPlotNew=Plot[cE[\[ScriptM]],{\[ScriptM],0,\[ScriptM]MaxMax},PlotStyle->RGBColor[0,0,0]];
cFuncPlotNewPoints=Map[{{#,\[ScriptC][#]}}&,Table[\[ScriptM],{\[ScriptM],0,\[ScriptM]MaxMax,0.01}]];
Stable\[ScriptM]LocusPlot=Plot[{\[ScriptM]EDelEqZero[\[ScriptM]]},{\[ScriptM],0,\[ScriptM]MaxMax},PlotStyle->{Black,Dashing[{.01}],Thickness[Medium]}];
Stable\[ScriptM]LocusPoints=Map[{{#,\[ScriptM]EDelEqZero[#]}}&,Table[\[ScriptM],{\[ScriptM],0,\[ScriptM]MaxMax,0.1}]];
...
,Graphics[Text["Old Target \[UpperRightArrow]",{\[ScriptM]EBase,\[GothicG]+\[Mho]Base},{1,1}]]
