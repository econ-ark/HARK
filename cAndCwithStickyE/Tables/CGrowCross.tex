\begin{table}[t]  
\caption{Typical Micro Consumption Estimation on Simulated Data} 
...
Model of     &                                &                                &                                 &                                       &                 & \\  
Expectations & \multicolumn{1}{c}{$ \chi $} & \multicolumn{1}{c}{$ \eta $} & \multicolumn{1}{c|}{$ \alpha $} & \multicolumn{1}{c}{$\bar{R}^{2}$} &                 & nobs   
\\ \hline \multicolumn{2}{l}{Frictionless}  
\\ &  0.010  &        &        & 0.000 & & 8477951 %NotOnSlide   
\\ & (0.000) &      &      &  & &  %NotOnSlide   
\\ &    &    0.013    &        & 0.004 & & 8477951 %NotOnSlide   
\\ &  &   (0.000)   &      &  & &  %NotOnSlide   
\\ &    &        &     -0.006   & 0.000 & & 8477951 %NotOnSlide   
\\ &  &    &    (0.000)    &  & &  %NotOnSlide   
\\ &  0.050  &    0.017    &     -0.004   & 0.007 & & 8477951   
\\ & (0.000) &  (0.000)  &    (0.000)    &  & &    
