...
\\ $\breve{K}$ & \approx48.55 & SS Capital to Labor Productivity Ratio ($=12^{1/(1-\varepsilon)}$) 
...
\\ $\breve{\mathcal{R}}$ &\approx 1.015& SS Between-Period Return Factor ($=\daleth + \breve{\mathsf{r}}$) 
\\ \midrule  
\multicolumn{3}{c}{ \textbf{Preference Parameters} }  
\\ $\rho$ & 2. & Coefficient of Relative Risk Aversion 
\\ $\beta_{SOE}$ & \approx 0.963 & SOE Discount Factor ($=0.99 \cdot \PLives / (\breve{\mathcal{R}} \Ex [\pmb{\psi}^{-\CRRA}])$)
