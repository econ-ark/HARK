...
%\\  & & $M$  
%\\  & & $K$  
\\  & & $A$ & 9.30 &9.21 & 61.06 & 60.93   
\\  & & $C$ & 2.74 &2.74 & 3.49 & 3.49   
\\ \midrule  
  \multicolumn{3}{l}{Standard Deviations}  
\\ &    \multicolumn{4}{l}{Aggregate Time Series (`Macro')}  
%\  & & $\Delta \log \mathbf{M}$   
\\ & & $\log A $         & 0.408 & 0.397 & 0.276 & 0.273 
\\ & & $\Delta \log \CLevBF $  & 0.011 & 0.007 & 0.010 & 0.006 
\\ & & $\Delta \log \YLevBF $  & 0.011 & 0.011 & 0.009 & 0.009 
\\ &   \multicolumn{3}{l}{Individual Cross Sectional (`Micro')}  
\\ & & $\log \aLevBF $  & 1.054 & 1.056 & 1.006 & 1.006 
\\ & & $\log \cLevBF $  & 0.968 & 0.968 & 0.718 & 0.719 
\\ & & $\log p $  & 0.986 & 0.986 & 0.986 & 0.986 
\\ & & $\log \yLevBF | \yLevBF > 0 $  & 1.041 & 1.041 & 1.041 & 1.041 
\\ & & $\Delta \log \cLevBF $  & 0.096 & 0.096 & 0.057 & 0.057 
  
  
\\ \midrule \multicolumn{3}{l}{Cost of Stickiness}  
 & \multicolumn{2}{c}{5.87\text{e--4}}  
 & \multicolumn{2}{c}{4.87\text{e--4}}  
\\ \bottomrule  
 \end{tabular}   
 } 
 \usebox{\EqbmBox}  
