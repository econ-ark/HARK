\begin{table} \caption{Aggregate Consumption Dynamics in Rep Agent Markov Economy (11 states)} 
\label{tRAsim} 
\centering \small 
...
\\ & (0.285) & & & &0.447
\\ & & -0.35\text{e-4} & IV & 0.019 & 0.000
\\ & & (1.05\text{e-4}) & & &0.471
\\ 0.122 & 0.203 & 0.15\text{e-4} & IV & 0.023 & 0.532
\\ (0.527) & (0.544) & (2.06\text{e-4}) & & & 0.583
\\ \multicolumn{6}{l}{Memo: For instruments $\mathbf{Z}_{t}$, $\Delta \log \mathbf{C}_{t+1}$ $= \mathbf{Z}_{t} \zeta,~~\bar{R}^{2}=$ 0.022 }  
...
\\ & (0.162) & & & &0.196
\\ & & -0.58\text{e-4} & IV & 0.081 & 0.000
\\ & & (0.50\text{e-4}) & & &0.023
\\ 0.642^{\bullet \bullet \bullet } & 0.106 & 0.08\text{e-4} & IV & 0.193 & 0.325
\\ (0.227) & (0.289) & (0.79\text{e-4}) & & & 0.503
\\ \multicolumn{6}{l}{Memo: For instruments $\mathbf{Z}_{t}$, $\Delta \log \mathbf{C}_{t+1}^*$ $= \mathbf{Z}_{t} \zeta,~~\bar{R}^{2}=$ 0.194,~~$\var(\xi_t)=$ 0.03\text{e-4} }  
\\ \hline 
