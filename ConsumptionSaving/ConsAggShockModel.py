...
class CobbDouglasEconomy(Market):            
    ...
    def makeZeroAggShkHist(self):
        ...
        PermShkAggHist = np.ones(sim_periods)

        TranShkAggHist = np.ones(sim_periods)
...
if __name__ == '__main__':
    ...
    AggShockExample.sim_periods = 480
