...
Econ-Ark. To make your dream a reality, follow these steps:
  ...
  3. Be patient: Someone from the development team will look at your contribution and either merge it into the main repository or return it with comments. See section 0.1.3 for procedures followed by the HARK team when evaluating outside contributions. 

#### 0.1.3 Submission Approval Process
...
will consider when choosing whether to accept a submission include:
  ...
  2. Is the code well documented? Code submissions should have properly formatted docstrings for each new function, class, method, and module (see section 0.1.5) and enough comments for a reader to follow the algorithm. 
  ...
  6. Does the code use HARK conventions? To the best of your ability, contributions to HARK should follow the style guidelines in section 0.1.4. We don’t demand perfection, as these are guidelines rather than rules. 
...
#### 0.1.5 Documentation Conventions
