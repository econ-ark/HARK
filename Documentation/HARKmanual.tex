...
\begin{authorsinfo}
\name{
Carroll: \url{http://econ.jhu.edu/people/ccarroll/}, email: \href{mailto:ccarroll~AT~jhu.edu}{\texttt{ccarroll~AT~jhu.edu}}
}
\name{
Kaufman: \href{mailto:alexander.kaufman~AT~cfpb.gov}{\texttt{alexander.kaufman~AT~cfpb.gov}}
}
\name{
Low: \href{mailto:david.c.low~AT~cfpb.gov}{\texttt{david.c.low~AT~cfpb.gov}}
}
\name{
Palmer: \href{mailto:nathan.m.palmer~AT~ofr.treasury.gov}{\texttt{nathan.m.palmer~AT~ofr.treasury.gov}}
}
\name{
White: \href{mailto:mnwecon~AT~udel.edu}{\texttt{mnwecon~AT~udel.edu}}
}
\end{authorsinfo}
