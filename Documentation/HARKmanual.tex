...
\begin{enumerate}
\item \textbf{Download Anaconda:} Go to \href{https://www.anaconda.com/download/}{https://www.anaconda.com/download/} and download Anaconda for your operating system; be sure to get the version for Python 3.

\item \textbf{Install Anaconda:} Follow the easy instructions on that page to install Anaconda.

  % Now we have a requirements.txt file so this is not necessary
