...
\noindent
This imports the module and gives it a local name of \texttt{import\_name}. We can access a function within this module by simply typing: \texttt{import\_name.function\_name()}. The following example will illustrate the usage of these commands. There is a module in HARK named \texttt{HARKutilities}. Amongst other things, it contains the function for calculating CRRA utility. In order to calculate CRRA utility with a consumption of 1 and a coefficient of risk aversion of 2 we run:\\
