...
Euler1 = {u'[cE[\[ScriptM]Et]] == \[Bet] (\[Mho] u'[\[Kappa] (\[ScriptM]Et-cE[\[ScriptM]Et]) \[ScriptCapitalR]]+(1-\[Mho]) u'[cE[(\[ScriptM]Et-cE[\[ScriptM]Et]) \[ScriptCapitalR]+1]])};
     ...
     (
       (
         (
           ...
           ) /. (-\[ScriptC]E + \[ScriptM]E) \[ScriptCapitalR] -> \[ScriptB]E
         ) /. 1 + \[ScriptB]E -> \[ScriptM]E
       ) /. \[ScriptB]E \[Kappa] -> \[ScriptC]U
     ) /. cE[\[ScriptM]E] -> \[ScriptC]E
...
\[Phi]Analytical0 = \[Phi]Solve0 /. ExpParams1;
