...
PermGroFac_i = [1.01**0.25]  # Permanent income growth factor (no perm growth)
...
init_infinite = {"CRRA":CRRA,
                ...
                "CubicBool":CubicBool,
                "vFuncBool":vFuncBool,
                "PermShkStd":PermShkStd_i,  #will be overwritten
                "PermShkCount":PermShkCount,
                "TranShkStd":TranShkStd_i,  #will be overwritten
                "TranShkCount":TranShkCount,
                "UnempPrb":UnempPrb,
                "IncUnemp":IncUnemp,
                "UnempPrbRet":None,
