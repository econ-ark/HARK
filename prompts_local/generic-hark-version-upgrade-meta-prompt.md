...
## CRITICAL: Accessible Diff Methods

**Do NOT rely solely on release notes or documentation.** You MUST actually diff the source code to discover ALL breaking changes.
